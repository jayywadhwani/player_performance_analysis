...
def player_performance_analysis_total():
    ...
    plt.title("Runs Scored Against Each Opposition in Test",color="white",fontsize="16")
    plt.axis("equal")  
    ...
    plt.title("Runs Scored Against Each Opposition in ODI",color="white",fontsize="16")
    plt.axis("equal") 
    ...
    plt.title("Runs Scored Against Each Opposition in T20",color="white",fontsize="16")
    plt.axis("equal")
